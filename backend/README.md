...
## Project Structure
    ...
    ├── testapiautoteammemb_72236  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_72236`
...
2. Clone this repo and `cd testapiautoteammemb_72236`
